...
class LLM:
    ...
    **sparsity_kwargs):
        ...
        model_class = AutoModelLM.from_pretrained(model_class_str)
        ...
        model_size = getattr(self.model_executor, "num_parameters") * 2.2
        ...
        logger.info(f"  GPU VRAM Size    {total_memory / (1024 * 1024 * 1024)} GB")
